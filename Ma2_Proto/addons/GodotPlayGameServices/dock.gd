...
static func write_res_file(app_id: String) -> void:
	var file := FileAccess.open("android/build/res/values/strings.xml", FileAccess.WRITE)
	file.store_string("<?xml version=\"1.0\" encoding=\"utf-8\"?><resources><string translatable=\"false\" name=\"game_services_project_id\">%s</string></resources>" % app_id)
